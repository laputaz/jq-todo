function drawKumamon() {
    ...
    if (ku.getContext) {
        ...
        bearBody(ctx, 110, 241, 280, 40, 380, 140, "#000");
        //左耳朵
        ...
        //眉毛
        bearEyebrow(ctx, 20, 10, 165, 133, 130, 32, "#fff");
        ...
        //嘴
        paintQuadratic(ctx, 235, 196, 253, 110, "#000");
        paintQuadratic(ctx, 290, 196, 253, 110, "#000");
        //鼻子
        ctx.moveTo(228, 217);
        paintOval(ctx, 248, 210, 20, 17, 1, "#000");
        ctx.moveTo(228, 142);
        paintRotatedOval(ctx, 248, 139, 20, 13, 1, "#000", 180);
        //腮红
        ctx.moveTo(99, 227);
